    ...
    print(json.dumps({
        "hookSpecificOutput": {
            ...
            "additionalContext": (
                ...
                f"write tight convo summary to memory (max 150 words, 3-7 bullets: what changed, decisions, pending — skip narration), add MEMORY.md pointer, file atoms to ~/NardoWorld/. "
